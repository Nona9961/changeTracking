...
class ChangeTest {
    ...
    class BasicStructureTests {
        ...
        @Test
        @DisplayName("ValueChange 应能正确存储字段变更信息")
        void valueChange_shouldHoldValueChangeData() {
            final ValueChange change = new ValueChange("path", "full.path", "path", null, false, "old", "new");
        ...
        void containerChange_shouldHoldPathAndChildren() {
            final List<Change> children = List.of(
                    new ValueChange("child.path", "parent.child.path", "path", null, false, "a", "b")
            );
        ...
        void containerChange_shouldCopyChildrenOnConstruction() {
            ...
            children.add(new ValueChange("other.path", "parent.other.path", "other", null, false, "a", "b"));
        ...
        void itemAddedChange_shouldHoldAddedItemData() {
            final ValueNode addedItem = new PrimitiveNode("added");
    ...
    class FieldNameTests {
        ...
        void fieldName_simpleField_shouldReturnFieldName() {
            final ValueChange change = new ValueChange("name", "name", "name", null, false, "old", "new");
        ...
        void fieldName_pureIndexPath_shouldReturnNull() {
            final ItemAddedChange change = new ItemAddedChange("[1]", "items[1]", null, "items", true, new PrimitiveNode("added"));
            assertNull(change.fieldName());
        }
    }
    ...
    class CollectionFieldNameTests {
        ...
        void collectionFieldName_rootField_shouldReturnNull() {
            final ValueChange change = new ValueChange("status", "status", "status", null, false, "old", "new");
            assertNull(change.collectionFieldName());
        }
        ...
        void collectionFieldName_singleLevelCollection_shouldReturnCollectionName() {
            final ValueChange change = new ValueChange("name", "items[1].name", "name", "items", true, "old", "new");
            assertEquals("items", change.collectionFieldName());
        }
        ...
        void collectionFieldName_nestedCollection_shouldReturnNearestCollectionName() {
            final ValueChange change = new ValueChange("value", "items[1].subItems[101].value", "value", "subItems", true, "old", "new");
        ...
        void collectionFieldName_deepNestedCollectionItem_shouldReturnNearestCollectionName() {
            ...
            final ValueChange change = new ValueChange("value", "items[1].subItems[101].specs[1001].value", "value", "specs", true, "old", "new");
